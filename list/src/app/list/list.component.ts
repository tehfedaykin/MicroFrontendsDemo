...
import { Villager, Personality, Species, Hobby, VillagerSortOptions, VillagersService} from '../villagers.service';
...
export class ListComponent implements OnInit, OnDestroy {
  ...
  constructor(private apiService: VillagersService) { }
